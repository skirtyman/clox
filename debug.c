...
// Print an invoke instruction, showing the method being called and the number of supplied arguments.
...
// Print an instruction with a byte operand.
...
// Print an instruction with a 2-byte operand.
